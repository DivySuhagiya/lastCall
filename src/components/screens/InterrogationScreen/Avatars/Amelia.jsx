...
export function Amelia(props) {
	...
	const fetchAndPlayStreaming = async (inputText) => {
		...
		mediaSource.addEventListener("sourceopen", async () => {
			try {
				...
				const response = await Kokoro_API(agentResponse, "af_heart");
	...
	const { animations } = useGLTF("/animations/Amelia_Idle_Animation.glb");
...
useGLTF.preload("/models/Amelia.glb");
useGLTF.preload("/animations/Amelia_Idle_Animation.glb");
