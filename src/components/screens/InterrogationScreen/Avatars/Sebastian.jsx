...
export function Sebastian(props) {
	...
	const { animations } = useGLTF("/animations/Sebastian_Idle_Animation.glb");
...
useGLTF.preload("/models/Sebastian.glb");
useGLTF.preload("/animations/Sebastian_Idle_Animation.glb");
